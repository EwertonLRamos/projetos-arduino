...
#define servoBase        9  // Porta Digital do Servo da Base
#define servoAlturaBraco 6  // Porta Digital do Servo da Altura do Braço
...
#define potAlturaBraco  A0  // Porta Analógica do Potenciometro para Controle da Altura do Braço
#define potAnguloBraco  A4  // Porta Analógica do Potenciometro para Controle do Ângulo do Braço
#define potGarra        A5  // Porta Analógica do Potenciometro para Controle da Garra.

#define botaoCongela    10  // Porta Digital do Botao Congela
